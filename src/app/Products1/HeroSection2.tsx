...
export default function Herosection2() {
    ...
    return (
        <div className="flex flex-col border w-[1535px] h-[690px] bg-[#FAFAFA]">
            ...
            <div className="flex w-[1535px] h-[598px]">
                <div className="flex w-[1050px] h-[598px] mx-[242.5px] pb-12 gap-[30px]">
                    ...
                    <div className="relative flex flex-col w-[510px] h-[471px] gap-[21px]">
                        <h1 className="absolute flex flex-col w-[156px] h-[30px] ml-6 mt-[11px] text-[#252B42] font-bold text-[20px] leading-[30px] tracking-[0.2px]">Floating Phone</h1>
